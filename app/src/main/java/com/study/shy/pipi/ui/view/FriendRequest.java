...
public class FriendRequest extends Dialog implements View.OnClickListener {
    ...
    public FriendRequest(Context context,String user,String reason,int layoutResID,int[] listenedItem){
